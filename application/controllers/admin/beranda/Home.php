...
class Home extends CI_Controller {
	...
	public function tambah(){
		...
		if($this->form_validation->run() == FALSE) {
			...
			$this->Manajemen_home_model->tambahData($data2,'tbl_manajemen_home');
	...
	{
		$this->Manajemen_home_model->hapusData($id);
		redirect('admin/beranda/home');
	}
	...
	public function ubah($id){
		...
		$this->Manajemen_home_model->ubahData($id,$data2);
		redirect('admin/beranda/home', $data2);
